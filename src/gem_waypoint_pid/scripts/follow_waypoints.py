...
class WaypointPIDControl(object):
    ...
    def start_drive(self):
        ...
        while not rospy.is_shutdown():
            ...
            target_orientation = np.arctan2(target_y-cur_y,target_x-cur_x)
            target_speed = 20

            # TODO: define your feedback value
            # cur_feedback_val = ...
            currentPose=self.getModelState()
            result = self.pid(currentPose=currentPose, referencePose=[target_x,target_y,target_orientation,target_speed])
            ...
            print("output_speed:",result[0],"cur speed:",current_v)

            # print(
            #     f"Feedback val: {cur_feedback_val}; angle: {result[1]}"
            # )
